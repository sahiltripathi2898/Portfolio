			...
			about_me: [
				{
					id: 'first-p-about',
					content:
						"NIT Jaipur '21 batch passout 🎓 . Loves building websites / web-apps and has a demonstrated history of working with web technologies like ReactJS and NodeJS 👨‍💻 . Excellent with programming and a good hold over Data Structures and Algorithms."
				},
				{
					id: 'second-p-about',
					content:
